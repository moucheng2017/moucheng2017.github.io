...
1. **Comprehensive Representation:** The artifact must encode the complete clinical state of the patient at a given time, rather than a single data modality. Such a comprehensive clinical representation can be seen as the _Clinical_ _Platonic_ _Representation_ of the patient. One such format is medical imaging. 
